...
/**
 * tree_height - only measures the height of a binary tree
...
/**
 * tree_size_h - only measures the sum of heights of a binary tree
...
/**
 * _preorder - go through a binary tree using pre-order traversal
...
/**
 * heap_extract - only extracts the root node from a Max Binary Heap
