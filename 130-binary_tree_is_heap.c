...
/**
 * binary_tree_size - to measure size of a binary tree
 *
 * @tree: tree root
...
/**
 * tree_is_complete - to check if tree is complete
 *
...
/**
 * binary_tree_is_complete - only calls to tree_is_complete function
 *
 * @tree: tree root
 * Return: 1 if tree is complete, 0 otherwise
 */
...
/**
 * check_parent - only checks if parent has a greater value than its childs
 *
