...
/**
 * create_node - To create new level order_queue_t node
 *
...
/**
 * free_queue - Will free a level order_queue_t queue
 *
...
/**
 * push - will push a node to the back of a level order_queue_t queue
 *
...
/**
 * pop - To pop the head of a level order_queue_t queue
 *
 * @head: Double pointer to head of queue
 *
 */
...
/**
 * binary_tree_is_complete - To only check if a binary tree is complete
 *
