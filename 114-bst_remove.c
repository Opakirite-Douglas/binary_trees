...
/**
 * find_node - Func finds a node with a given value in a binary search tree.
...
/**
 * replace_with_successor - This replaces a node with its inorder \
...
/**
 * bst_remove - This removes a node with a given value in a binary search tree.
