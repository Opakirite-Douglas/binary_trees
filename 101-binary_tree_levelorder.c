...
/**
 * create_node - To only create a new level order_queue_t node
 *
...
/**
 * free_queue - This frees a level order_queue_t queue.
 *
...
/**
 * pint_push - To run a func on a given binary tree
...
/**
 * pop - This pops the head of a level order_queue_t queue
 *
...
/**
 * binary_tree_levelorder - To traverse a
